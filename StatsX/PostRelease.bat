...
set "outputFile=..\Release\StatsX_mm.dll"

set "copyPath1=C:\Files\Desktop\HLDS\hlds\cstrike\addons\statsx\dlls"
set "copyPath2=D:\Files\Desktop\HLDS\hlds\cstrike\addons\statsx\dlls"
